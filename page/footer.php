<div class="footer">
    ...
    <div class="foot-middle">
        <div class="time-block" id="foot-elemets">
            <img class="" src="../img/watch.svg" alt="">
            <p class="time-text" id="middle-text">Пн-Пт с 8:00 до 18:00</p>
        </div>
        <div class="tel-block" id="foot-elemets">
            <img class="" src="../img/telephone.svg" alt="">
            <p class="tel-text" id="middle-text">+8 999 999 99 99</p>
        </div>
        <div class="email-block" id="foot-elemets">
            <img class="" src="../img/email.svg" alt="">
            <p class="email-text" id="middle-text">grandprom@gmail.com</p>
        </div>
        <div class="location-block" id="foot-elemets">
            <img class="" src="../img/marker.svg" alt="">
            <p class="location-text" id="middle-text">Фактический адрес: Самарская область, г. Тольятти, новый проезд 8, подъезд 4, офис 307, 308.</p>
        </div>
        <div class="location-block" id="foot-elemets">
            <img class="" src="../img/marker.svg" alt="">
            <p class="location-text" id="middle-text">Юридический адрес: Самарская область, г. Тольятти, ул. Ленинградская, д. 15, кв. 15</p>
        </div>
    </div>
