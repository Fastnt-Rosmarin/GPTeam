<div class="popup-clarification-delite_block">
    <div class="clarification-delite_block">
        ...
        <div class="clar-dil-button-block">
            ...
            <button class="cancellation_block confir_button" id="clous-clar">Отмена</button>
        </div>
    </div>
</div>
...
<div class="popup-clarification_block">
    <div class="clarification-_block">
        ...
        <div class="clar-dil-button-block">
            <button class="confirmation_block" id="confir_button">Да</button>
            <button class="cancellation_block" id="clous-end">Отмена</button>
        </div>
    </div>
</div>

<div class="popup-error-win_block">
    <div class="error-win_block">
        <div class="error-win-text-block">
